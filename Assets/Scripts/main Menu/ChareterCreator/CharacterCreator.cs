...
namespace RPG.MainMenu.ChareterCreator
{
    public class CharacterCreator : MonoBehaviour, ISaveable
    {
        ...
        private void InitBody()
        {
            ...
            SetSkinColor("Race 1", Color.white);
            SetHairColor("hairColor", new Color(0.3098039f, 0.254902f, 0.1764706f));
        ...
        public void SetSkinColor(string name, Color color)
        {
        ...
        //name just added the make dynamic
        ...
        public void SetSliderHead(float index)
        {
            int i = Mathf.RoundToInt(index);
            SetHead(i, "heads");
        }

        public void SetSliderEyeBrows(float index)
        {
            int i = Mathf.RoundToInt(index);
            SetEyebrows(i, "eyeBrows");
        }

        public void SetSliderHair(float index)
        {
            int i = Mathf.RoundToInt(index);
            SetHair(i, "hair");
        }

        public void SetSliderFacialHair(float index)
        {
            int i = Mathf.RoundToInt(index);
            SetFacialHair(i, "FacialHair");
        }

        public void SetSliderSkinColor(float index)
        {
            int i = Mathf.RoundToInt(index);
            ...
            {
                case 0:
                    SetSkinColor("Race 1", whiteSkin);
                    break;
                case 1:
                    SetSkinColor("Race 2", brownSkin);
                    break;
                case 2:
                    SetSkinColor("Race 3", blackSkin);
                    break;
